...
import sg.com.para.intranet.expense.services.model.ExpenseClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"intranet-expense-service-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "intranet-expense-service-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"sg.com.para.intranet.expense.services.model.impl.ExpenseImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new sg.com.para.intranet.expense.services.NoSuchExpenseException();
		}
